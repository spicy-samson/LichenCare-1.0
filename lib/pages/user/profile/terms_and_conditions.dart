...
class _TermsAndConditionsState extends State<TermsAndConditions> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: (!widget.onBoot) ? (navigatorHidden)? null: _lichenCheckBtn(context):null,

      // Bottom navigation bar
      bottomNavigationBar: (!widget.onBoot) ? (navigatorHidden) ? null: _bottomNavBar(context) : null,
    );
  }
